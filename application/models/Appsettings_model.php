...
class Appsettings_model extends CI_model
{
    ...
    public function ubahdatamidtrans($data)
    {
        $this->db->set('id_merchant', $data['id_merchant']);
        $this->db->set('client_key', $data['client_key']);
        $this->db->set('server_key', $data['server_key']);
        $this->db->set('midtrans_status', $data['midtrans_status']);
        $this->db->set('midtrans_active', $data['midtrans_active']);
