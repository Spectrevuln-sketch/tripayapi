          ...
          <div class="col-lg-7 mx-auto text-white">
            <div class="row align-items-center d-flex flex-row">
              ...
              <div class="col-lg-6 error-page-divider text-lg-left pl-lg-4">
                <h2>SORRY!</h2>
                <h3 class="font-weight-light">Halaman Tidak Ditemukan<br><a class="badge badge-light text-primary"href="https://karinesia.com">Informasi Kontak</a></h3>
              </div>
            </div>
            <div class="row mt-5">
              <div class="col-12 mt-xl-2">
                <p class="text-white font-weight-medium text-center">Copyright &copy; Karinesia Team 2020 All rights reserved.</p>
              </div>
            </div>
          </div>
        </div>
