                    ...
                    <div class="row w-100">
                        <div class="col-lg-4 mx-auto">
                            <div class="auth-form-light text-left p-5">
                                ...
                                <div class="mt-5">
                                    <button type="submit" class="btn btn-block btn-lg font-weight-medium" style="color: #fff;background: linear-gradient(88deg, #0064D3, #6DC0FF);border-color: #03a9f3;">Masuk</button>
                                    <br>
                                    <span class="text-muted d-block text-center  justify-center ">Copyright © 2020 <a class="text-success" href="https://karinesia.com">Delip</a>. All rights reserved.</span>
                                </div>
                                <?= form_close(); ?>
                            </div>
                        </div>
